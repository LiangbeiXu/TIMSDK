    ...
    GG4c: function(t, e, s) {
        ...
        e.a = {
            data: function() {
                return {
                    password: "",
                    userIDList: new Array(30).fill().map(function(t, e) {
                        return "user" + e
                    }),
                    selectedIndex: 1,
                    loading: !1
            ...
            methods: {
                handleLogin: function() {
                    ...
                    if (this.myInfo.userID && e === this.myInfo.userID) wx.switchTab({
                        url: "../index/main"
                    });
                    else {
                        if (this.loading = !0, this.myInfo.userID) return this.$store.dispatch("resetStore"), void wx.$app.logout().then(function() {
                            t.login(e)
                        });
                        this.login(e)
                    }
